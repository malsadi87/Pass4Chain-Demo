...
from ledger_sync.deltas.decoding import data_to_dicts
from ledger_sync.deltas.updating import get_updater
...
def _handle_events(database, events):
    ...
    if block_num:  # sometimes events without blocks occur (eg. pings)
